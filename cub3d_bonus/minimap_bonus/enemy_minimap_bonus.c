...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   enemy_minimap_bonus.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: dfasius <marvin@42.fr>                     +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/05/26 13:46:50 by dfasius           #+#    #+#             */
/*   Updated: 2025/05/26 13:46:51 by dfasius          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_enemies_init(t_var *data, t_emini *mini, int i)
{
	...
	mini->offset_x = (mini->ex - mini->enemy_tile_x * TILE_SIZE)
		/ (float)TILE_SIZE;
	mini->offset_y = (mini->ey - mini->enemy_tile_y * TILE_SIZE)
		/ (float)TILE_SIZE;
	mini->draw_x = mini->rel_x * MINIMAP_TILE_SIZE
		+ mini->offset_x * MINIMAP_TILE_SIZE;
	mini->draw_y = mini->rel_y * MINIMAP_TILE_SIZE
		+ mini->offset_y * MINIMAP_TILE_SIZE;
