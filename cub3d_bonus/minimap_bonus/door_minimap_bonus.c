...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   door_minimap_bonus.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: dfasius <marvin@42.fr>                     +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/05/26 13:46:43 by dfasius           #+#    #+#             */
/*   Updated: 2025/05/26 13:46:45 by dfasius          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	check_map_door(t_var *data, int tile, int draw_x, int draw_y)
{
	if (tile == DOORH_CLOSE)
		...
		draw_horizontal_door_open(&data->image,
			draw_x, draw_y, DOOR_OPEN_COLOR);
