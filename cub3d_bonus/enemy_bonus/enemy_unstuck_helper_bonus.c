...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   enemy_unstuck_helper_bonus.c                       :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: dfasius <marvin@42.fr>                     +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/05/26 13:43:26 by dfasius           #+#    #+#             */
/*   Updated: 2025/05/26 13:43:29 by dfasius          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ebfs_four_helper(char **map, t_enemy_bfs *bfs)
{
	...
	while (bfs->i < 4)
	{
		...
		if (bfs->nx >= 0 && bfs->ny >= 0
			...
			&& !bfs->visited[bfs->ny][bfs->nx]
			&& (map[bfs->ny][bfs->nx] == EMPTY_SPACE
			|| map[bfs->ny][bfs->nx] == WIN_BLOCK
			|| map[bfs->ny][bfs->nx] == DOOR_SPACE))
		{
