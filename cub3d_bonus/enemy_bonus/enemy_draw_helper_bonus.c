...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   enemy_draw_helper_bonus.c                          :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: dfasius <marvin@42.fr>                     +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/05/26 13:42:53 by dfasius           #+#    #+#             */
/*   Updated: 2025/05/26 13:42:54 by dfasius          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	screen_draw(t_var *data, t_edraw *draw)
{
	...
	while (draw->x < draw->sprite_size)
	{
		...
		if (draw->ray_idx < 0 || draw->ray_idx >= NUM_RAYS
			|| draw->dx > data->zbuffer[draw->ray_idx])
		{
			draw->x++;
			continue ;
		}
